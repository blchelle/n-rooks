...
/**
 * This test the case when a user enters an invalid cell
 * The function used to validate that should return false
 */
...
/**
 * This test the case when a user enters duplicate cells
 * The function used to validate that should return false
 */
...
/**
 * This test the case when all the cells the user enters are valid
 */
